...
import {Fight as GameFightModel} from '../modules/Fight'

import DangerCard from './DangerCard'
import Button from 'material-ui/Button';

interface GameFightProps extends DefaultProps {
    fight: GameFightModel, 
            ...
            <div className="fight-player-interface">
                ...
                <div className="fight-result-info-and-actions">
                    <div className="fight-danger-infos">
                        <span v-if="!fight.finished" id="fight-danger-temporary-result" :className="fight.getResult() >= 0 ? 'fight-danger-temporary-result-success' : 'fight-danger-temporary-result-negative'">
                            {{ fight.getResult() }}
                        </span>
                ...
                <div className="fight-danger-fight-cards-used">
                    <PlayableCard v-for="(card, index) in fight.arrayFightCardUsed" 
                        card="card" 
                        in-fight="!fight.finished" 
                        selectedToDelete="cardsToDelete.indexOf(card) != -1" 
                        select="playableCardClicked"
